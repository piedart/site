...
Bitwise flags are an efficient method of storing multiply ON/OFF values in the same value - removing the need for storing several values in a database. For example, what may previously be stored as:
