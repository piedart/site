    ...
    <div className="flex flex-col items-center">
      <div className="my-5">
        ...
        <h3 className="font-light text-md my-6">
          Over the years I&apos;ve had the... pleasure... to start - and abandon - many projects, ranging from compilersto API
      ...
      <div className="w-11/12 h-[0.5px] bg-primary bg-opacity-80 mb-14"></div>
