...
export default function blog() {
  return (
    <div className="w-screen px-[5%] lg:px-[20%] lg:pt-[10vh]h-screen  mt-[10vh]">
      <h2 className="text-primary font-bold text-5xl px-[5%]">Blog</h2>
            ...
            <Link href={`/blog/${blog.link}`} key={i}>
              <div className=" my-5 flex flex-col lg:flex-row w-full items-center ease-in-out duration-200 rounded-xl p-2 lg:p-8 hover:cursor-pointer hover:bg-stone-50 hover:scale-105">
                ...
                <div className="flex flex-col w-3/4">
                  <h3 className="text-3xl text-primary font-bold">{blog.title}</h3>
                  ...
                  <div className="flex flex-row items-center mt-3">
                    ...
                    <p className="text-lg">
                      <span className="text-primary font-semibold mr-2">Read Time:</span>
                      {blog.readTime}
                    </p>
                  </div>
                </div>
